-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/convolutionPlayback/convolutionCore11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: convolutionCore11
-- Source Path: convolutionPlayback/convolutionPlayback/recordingConvolver/convolutionCore11
-- Hierarchy Level: 2
-- Model version: 1.104
-- 
-- -------------------------------------------------------------
...
END convolutionCore11;


ARCHITECTURE rtl OF convolutionCore11 IS
  ...
  COMPONENT Detect_Rise_Positive_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : Detect_Rise_Positive_block2
    USE ENTITY work.Detect_Rise_Positive_block2(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : Detect_Rise_Positive_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              U => ReadIndex_out2,
