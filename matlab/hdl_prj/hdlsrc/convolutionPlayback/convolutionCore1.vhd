-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/convolutionPlayback/convolutionCore1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: convolutionCore1
-- Source Path: convolutionPlayback/convolutionPlayback/recordingConvolver/convolutionCore1
-- Hierarchy Level: 2
-- Model version: 1.104
-- 
-- -------------------------------------------------------------
...
END convolutionCore1;


ARCHITECTURE rtl OF convolutionCore1 IS
  ...
  COMPONENT Detect_Rise_Positive_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : S_R_Flip_Flop
    USE ENTITY work.S_R_Flip_Flop(rtl);

  FOR ALL : DualPortRAM_generic
    USE ENTITY work.DualPortRAM_generic(rtl);

  FOR ALL : Detect_Rise_Positive_block
    USE ENTITY work.Detect_Rise_Positive_block(rtl);
...
BEGIN
  ...
  u_S_R_Flip_Flop_inst : S_R_Flip_Flop
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => new_sample,
  ...
  u_Detect_Rise_Positive : Detect_Rise_Positive_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              U => ReadIndex_out2,
  ...
  count_3 <= count_2 WHEN new_sample = '0' ELSE
      count_reset;
  ...
  ReadIndex_out2 <= count_hit WHEN new_sample = '0' ELSE
      zero_1;
  ...
  count_6 <= count_4 WHEN new_sample = '0' ELSE
      count_5;
  ...
  Switch1_out1 <= Switch2_out1_1 WHEN new_sample_1 = '0' ELSE
      preload_signed;
