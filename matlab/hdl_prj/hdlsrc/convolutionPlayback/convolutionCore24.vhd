-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/convolutionPlayback/convolutionCore24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: convolutionCore24
-- Source Path: convolutionPlayback/convolutionPlayback/recordingConvolver/convolutionCore24
-- Hierarchy Level: 2
-- Model version: 1.104
-- 
-- -------------------------------------------------------------
...
END convolutionCore24;


ARCHITECTURE rtl OF convolutionCore24 IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT S_R_Flip_Flop_block15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          in1                             :   IN    std_logic;
  ...
  COMPONENT Detect_Rise_Positive_block16
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : S_R_Flip_Flop_block15
    USE ENTITY work.S_R_Flip_Flop_block15(rtl);

  FOR ALL : DualPortRAM_generic
    USE ENTITY work.DualPortRAM_generic(rtl);

  FOR ALL : Detect_Rise_Positive_block16
    USE ENTITY work.Detect_Rise_Positive_block16(rtl);
...
BEGIN
  ...
  u_S_R_Flip_Flop_inst : S_R_Flip_Flop_block15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              in1 => new_sample_1,
  ...
  u_Detect_Rise_Positive : Detect_Rise_Positive_block16
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              U => ReadIndex_out2,
