-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/convolutionPlayback/convolutionCore10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: convolutionCore10
-- Source Path: convolutionPlayback/convolutionPlayback/recordingConvolver/convolutionCore10
-- Hierarchy Level: 2
-- Model version: 1.104
-- 
-- -------------------------------------------------------------
...
END convolutionCore10;


ARCHITECTURE rtl OF convolutionCore10 IS
  ...
  COMPONENT Detect_Rise_Positive_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : Detect_Rise_Positive_block1
    USE ENTITY work.Detect_Rise_Positive_block1(rtl);
...
BEGIN
  ...
  u_Detect_Rise_Positive : Detect_Rise_Positive_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              U => ReadIndex_out2,
